...
args="--algorithm=$algorithm --identifier=$identifier --game=RUN"
#args="--algorithm=$algorithm --spline --identifier=spline --game=RUN"
...
CUDA_VISIBLE_DEVICES=3, python main.py --action-space=10 --resume=$resume --load-last-model $args $aux &

CUDA_VISIBLE_DEVICES=3, python main.py --action-space=20 --resume=$resume --load-last-model $args $aux &

#CUDA_VISIBLE_DEVICES=3, python main.py --action-space=40 --resume=$resume --load-last-model $args $aux &
