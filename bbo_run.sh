...
args="--debug --learn-iteration=10 --pi-lr=1e-2 --algorithm=$algorithm --identifier=$identifier --grad-clip=0 --game=RUN --budget=1500 --explore=cone --alpha=1 --replay-memory-factor=80 --batch=1024 --epsilon=0.1"
