...
args="--best-explore-update --algorithm=$algorithm --identifier=$identifier --game=RUN --budget=1500 --replay-memory-factor=100 --n-explore=1024 --batch=1024"

CUDA_VISIBLE_DEVICES=0, python main.py --action-space=1 --resume=$resume --load-last-model $args $aux &

CUDA_VISIBLE_DEVICES=0, python main.py --action-space=2 --resume=$resume --load-last-model $args $aux &
CUDA_VISIBLE_DEVICES=0, python main.py --action-space=3 --resume=$resume --load-last-model $args $aux &

CUDA_VISIBLE_DEVICES=2, python main.py --action-space=5 --resume=$resume --load-last-model $args $aux &
